                ...
                return (
                    ...
                    <div key={index} className=" transition duration-500 ease-in-out hover:scale-105 bg-white rounded-lg overflow-hidden shadow-md">
                        ...
                        <div className="p-4">
                            ...
                            <p style={{fontFamily: 'Averia Sans Libre'}}
                               className="text-lg font-bold tracking-tighter mb-2">{tour.title},
                                <br/><span style={{fontFamily: 'Gloria Hallelujah'}}
                                           className="text-orange-500">{tour.city}</span></p>
                            <div className="flex justify-between items-center">
                                <p className="text-sm font-semibold "><span
                                    className="text-orange-600">${tour.price}</span>/Per Person</p>
                                <Button variant="outline" className="text-sm font-semibold bg-orange-500  text-white">Book
                                    Now</Button>
                            </div>
                        </div>
                    </div>
